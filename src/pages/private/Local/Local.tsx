        ...
        <>
          <main className={LocalStyle.main_container}>
            ...
            <section className={LocalStyle.section_images_additional}>
              ...
              <HighlightedImages onViewMore={(index)=> console.log("A ver mas", index)} onEdit={(index)=> console.log("A editar", index)} onDelete={(index)=> console.log("A eliminar", index)} images={local.additionalImages} />
            </section>
